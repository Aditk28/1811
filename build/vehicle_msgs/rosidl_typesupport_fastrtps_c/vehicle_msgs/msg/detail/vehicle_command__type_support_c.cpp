...
#include "vehicle_msgs/msg/detail/vehicle_command__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleCommand__ros_msg_type = vehicle_msgs__msg__VehicleCommand;
...
size_t get_serialized_size_vehicle_msgs__msg__VehicleCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleCommand__ros_msg_type * ros_message = static_cast<const _VehicleCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _VehicleCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_msgs__msg__VehicleCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vehicle_msgs
size_t max_serialized_size_vehicle_msgs__msg__VehicleCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_msgs__msg__VehicleCommand;
    is_plain =
      (
...
static size_t _VehicleCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vehicle_msgs__msg__VehicleCommand(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_msgs, msg, VehicleCommand)() {
