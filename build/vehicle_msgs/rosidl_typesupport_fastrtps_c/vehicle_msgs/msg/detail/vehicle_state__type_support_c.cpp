...
#include "vehicle_msgs/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleState__ros_msg_type = vehicle_msgs__msg__VehicleState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: battery_v
  {
    cdr << ros_message->battery_v;
  }

  // Field name: watchdog_tripped
  {
...
size_t get_serialized_size_vehicle_msgs__msg__VehicleState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleState__ros_msg_type * ros_message = static_cast<const _VehicleState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _VehicleState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_msgs__msg__VehicleState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vehicle_msgs
size_t max_serialized_size_vehicle_msgs__msg__VehicleState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_msgs__msg__VehicleState;
    is_plain =
      (
...
static size_t _VehicleState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vehicle_msgs__msg__VehicleState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_msgs, msg, VehicleState)() {
