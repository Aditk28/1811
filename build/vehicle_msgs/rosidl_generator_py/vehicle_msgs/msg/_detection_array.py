    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'vehicle_msgs.msg.DetectionArray')
            logger.debug(
            ...
            from vehicle_msgs.msg import Detection
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<vehicle_msgs/Detection>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['vehicle_msgs', 'msg'], 'Detection')),  # noqa: E501
    )
