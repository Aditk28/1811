...
{
  new (message_memory) vehicle_msgs::msg::VehicleState(_init);
}

void VehicleState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vehicle_msgs::msg::VehicleState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleState_message_member_array[4] = {
  {
    ...
    offsetof(vehicle_msgs::msg::VehicleState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_msgs::msg::VehicleState, speed_mps),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_msgs::msg::VehicleState, battery_v),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_msgs::msg::VehicleState, watchdog_tripped),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleState_message_members = {
  ...
  4,  // number of fields
  sizeof(vehicle_msgs::msg::VehicleState),
...
{
  return &::vehicle_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vehicle_msgs, msg, VehicleState)() {
  return &::vehicle_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleState_message_type_support_handle;
}
