...
: ${AMENT_CURRENT_PREFIX:="/vehicle_1811/install/obc_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/obc_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/obc_bringup/environment/path.sh"
